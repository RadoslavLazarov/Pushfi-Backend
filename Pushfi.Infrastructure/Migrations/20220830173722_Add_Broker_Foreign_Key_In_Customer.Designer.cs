...
namespace Pushfi.Infrastructure.Migrations
{
    ...
    [Migration("20220830173722_Add_Broker_Foreign_Key_In_Customer")]
    partial class Add_Broker_Foreign_Key_In_Customer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pushfi.Domain.Entities.Authentication.RefreshTokenEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Pushfi.Domain.Entities.Email.CustomerEmailHistoryEntity", b =>
                {
                    ...
                    b.Property<int?>("CreditScoreEQF")
                        .HasColumnType("int");

                    b.Property<int?>("CreditScoreEXP")
                        .HasColumnType("int");

                    b.Property<int?>("CreditScoreTUC")
                        .HasColumnType("int");

                    b.Property<int?>("HighOffer")
                        .HasColumnType("int");

                    b.Property<int?>("HighTermLoan")
                        .HasColumnType("int");

                    b.Property<int?>("LowOffer")
                        .HasColumnType("int");

                    b.Property<int?>("LowTermLoan")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pushfi.Domain.Entities.Customer.CustomerEntity", b =>
                {
                    b.HasOne("Pushfi.Domain.Entities.Broker.BrokerEntity", "Broker")
                        .WithMany("Customers")
